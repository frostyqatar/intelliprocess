...
// Extracted Component 1: ApiKeyForm
const ApiKeyForm: React.FC<{
  tempApiKey: string;
  setTempApiKey: (key: string) => void;
  handleSaveApiKey: () => void;
  setApiKey: (key: string | null) => void;
}> = ({ tempApiKey, setTempApiKey, handleSaveApiKey, setApiKey }) => (
...
// Extracted Component 2: ChatInterface
const ChatInterface: React.FC<{
  ...
  handleSend: () => void;
}> = ({ messages, isLoading, messagesEndRef, input, setInput, handleSend }) => (
    <>
